...
try {
    $cnx = connecter_db();
                if (!isset($_SESSION)) {
                    ...
                    $rc = $cnx->prepare("SELECT id, nom ,  description, idAuteur FROM  livre  where id = ? "); //protection contre l'injection SQL 
                    $rc -> execute(array($_GET['a']));
                    $book = $rc-> fetchAll();

                    $rn = $cnx->prepare("SELECT id, nomComplet  FROM  auteur ");
                    $rn -> execute();
                    $auteur = $rn-> fetchAll();
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="why-edit-box">
                        ...
                        <h4><?php echo $row1['nomComplet']; ?></h4>
