...
try {
    //connexion db 
    $cnx = connecter_db();
    $auteur = $cnx->prepare("SELECT nomComplet, email, profile from auteur");
    $auteur-> execute();
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                ...
                <form action="searchAuthor.php" class="form-inline my-2 my-lg-0">
    ...
    ?>
            <div class="col-xl-3 col-md-6 mb-4">
                <div class="card border-0 shadow">
                    <a href="file:///C:/Users/hp/Downloads/launcher/buy.html"><img>
                        src="assets/js/images/avatar-3637425_960_720.png" class="card-img-top" alt="..."
                        height="400"></a>
                    <div class="card-body text-center">
                        <div class="card-text text-black-50"><?php echo $row['nomComplet']; ?></div>
                        <div class="card-text text-black-50"><?php echo $row['profile']; ?></div>
