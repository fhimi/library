...
try {
    ...
    $cnx = connecter_db();
    //preparer la requete
    $rp = $cnx->prepare("SELECT id, email, password, status, profile FROM auteur where email=? and password = ?"); //protection contre l'injection SQL 
            ...
            <div class="col-xl-3 col-md-6 mb-4">
                <div class="card border-0 shadow">
                    ...
                    <div class="card-body text-center">
                        ...
                        <div>
                            <a href="descriptionBook.php?a=<?php echo $row['id']; ?>" class="btn btn-outline-light"><img
                                    src="assets/js/images/icons8-bookmark-30.png" height="26" alt="" /></a>

                            <a href="BuyBook.php?b=<?php echo $row['id']; ?>" class="btn btn-outline-light"><img
