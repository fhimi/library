        ...
        <div class="col-md-4 col-md-offset-4">
            <form class="form-horizontal" role="form" action="add.php?ida=<?php echo $_GET['idaut']; ?>" method="post">
                <fieldset>
                    ...
                    <!-- Text input-->
                    <div class="form-group">
                        <label class="col-sm-2 control-label" for="textinput">numero catégorie</label>
                        <div class="col-sm-10">
                            <input type="text" name="Catégorie" placeholder=" Catégorie" class="form-control">
                        </div>
                    </div>

                    <!-- Text input-->
                    <div class="form-group">
                        <label class="col-sm-2 control-label" for="textinput">Prix</label>
                        <div class="col-sm-10">
                    ...
                    <!-- Text input-->
                    <div class="form-group">
                        <label class="col-sm-2 control-label" for="textinput">quantité</label>
                        <div class="col-sm-10">
                            <input type="text" name="quantité" placeholder="quantité" class="form-control">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="description" placeholder="quantité" class="form-control">
                        </div>
                    </div>
                    <!-- Text input-->
                    <div class="form-group">
                        <label class="col-sm-2 control-label" for="textinput">valable</label>
                        <div class="col-sm-10">
                            <input type="text" name="valable" placeholder="quantité" class="form-control">
                        </div>
                    </div>
