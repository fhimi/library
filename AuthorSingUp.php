    ...
    <div class="container" id="wrap">
        <div class="row">
            <div class="col-md-6 col-md-offset-3">
                <form action="AuthorLogin.php" method="post" accept-charset="utf-8" class="form" role="form">
                    <legend>Author Sign Up</legend>
                    <input type="text" name="fullname" value="" class="form-control input-lg" placeholder="Full Name" />
                    <input type="text" name="email" value="" class="form-control input-lg"
                        placeholder="Your Email" /><input type="password" name="password" value=""
                        class="form-control input-lg" placeholder="Password" /><input type="password"
